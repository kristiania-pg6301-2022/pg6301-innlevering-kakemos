...
function ShowQuestion() {
    ...
    return <>
        ...
        <div>{Object.keys(question.answers)
            ...
            <button
                onClick={() => handleAnswer(document.querySelector('input[name="answerChoice"]:checked').value)}>Answer
            </button>
            <p></p>
            <div><Link to={"/"}>
...
function ShowAnswer() {
    return <div>
        <Routes>
            <Route path={"/correct"} element={<h1>YAY, you answered correctly!</h1>}/>
            <Route path={"/wrong"} element={<h1>Whoops! The answer was wrong!</h1>}/>
        </Routes>
